                    ...
                    <div className="edit-album-pane expanded">
                        ...
                        <div id="edit-album-card">
                            ...
                            <div className="input-grouping">
                                ...
                                <input id="name-input" name="name-input" type="text" value={ album.artist.name } onChange={(event) => updateAlbum(ALBUM_FIELDS.NAME, event, album)}/>
                            </div>

                            <div className="input-grouping">
                                <label htmlFor="title-input" className="album-label">Album Title:</label>
                                <input id="title-input" name="title-input" type="text" value={ album.album_title } onChange={(event) => updateAlbum(ALBUM_FIELDS.TITLE, event, album)}/>
                            </div>

                            <div className="input-grouping">
                                <label htmlFor="year-input" className="album-label">Year:</label>
                                <input id="year-input" name="year-input" type="text" value={ album.year } onChange={(event) => updateAlbum(ALBUM_FIELDS.YEAR, event, album)}/>
                            </div>

                            <div className="input-grouping">
                                <label htmlFor="condition-input" className="album-label">Record Condition:</label>
                                <input id="condition-input" name="condition" type="text" value={ album.condition } onChange={(event) => updateAlbum(ALBUM_FIELDS.CONDITION, event, album)}/>
                            </div>
                        </div>
                    </div>
                }
